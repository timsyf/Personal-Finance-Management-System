...
def create_home_tab(notebook):
    ...
    tk.Button(tab_frame, text="Add Transaction", command=lambda: add(entry_description, entry_amount, entry_date)).grid(row=3, column=0, columnspan=2)
    tk.Button(tab_frame, text="Update Transaction", command=lambda: update(entry_description, entry_amount, entry_date)).grid(row=4, column=0, columnspan=2)
    tk.Button(tab_frame, text="Delete Transaction", command=lambda: delete(entry_description, entry_amount, entry_date)).grid(row=5, column=0, columnspan=2)
...
def add(entry_description, entry_amount, entry_date):
